...
An AI-powered Environmental, Social, and Governance operations platform. Four integrated modules cover the full ESG governance lifecycle — from real-time incident triage to executive briefings and SOP generation.

**Live demo:** https://esg-governance-hub.onrender.com
...
### M2 · Knowledge Base
RAG-powered chat assistant grounded in 66 real ESG regulatory document chunks sourced from OSHA, HSE, EU-OSHA, ISO, EPA, and NIOSH. Answers include cited source links. Keyword-based retrieval with stopword filtering and title-boost scoring.
...
### M4 · Workflow Builder
AI-generated drag-and-drop SOP canvas. Describe any ESG process and GPT-4o produces a structured 5–8 step workflow with owners, SLA estimates, and actionable checklists. Steps animate in one-by-one. Reorder by dragging.
...
```bash
# 1. Clone
git clone https://github.com/richardlee8433/esg-governance-hub.git
cd esg-governance-hub/EHS_Ops_Hub
...
3. Set **Root Directory** to `EHS_Ops_Hub`
